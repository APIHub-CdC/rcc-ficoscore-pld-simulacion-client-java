...
import io.RCCFicoScorePLDSimulacion.client.ApiResponse;
import io.RCCFicoScorePLDSimulacion.client.Configuration;
import io.RCCFicoScorePLDSimulacion.client.Pair;
import io.RCCFicoScorePLDSimulacion.client.ProgressRequestBody;
import io.RCCFicoScorePLDSimulacion.client.ProgressResponseBody;
...
public class RCCFicoScorePLDSimulacionApi {
    private ApiClient apiClient;
    public RCCFicoScorePLDSimulacionApi() {
        this(Configuration.getDefaultApiClient());
    }
    public RCCFicoScorePLDSimulacionApi(ApiClient apiClient) {
